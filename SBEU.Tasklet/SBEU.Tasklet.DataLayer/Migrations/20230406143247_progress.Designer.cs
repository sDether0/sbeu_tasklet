            ...
            modelBuilder.Entity("XContentXTask", b =>
                {
                    ...
                    b.Property<string>("XTaskId")
                        .HasColumnType("text");

                    b.HasKey("ContentsId", "XTaskId");
            ...
            modelBuilder.Entity("SBEU.Tasklet.DataLayer.DataBase.Entities.XHistory", b =>
                {
                    ...
                    b.HasOne("SBEU.Tasklet.DataLayer.DataBase.Entities.TaskProgress", "Status")
                        .WithMany()
                    ...
                    b.HasOne("SBEU.Tasklet.DataLayer.DataBase.Entities.XIdentityUser", "Updater")
                        .WithMany()
